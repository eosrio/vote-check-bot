module.exports = {
    ...
    THRESHOLD_UPDATED: "Threshold updated! I'll send you a message when it is time to confirm your votes.",
    ...
    HELP: "I can help you keep track of your votes on the EOS platform. You can perform the following actions:\n\n" +
        ...
        "    Note that you can use this command to update your threshold.\n\n" +
